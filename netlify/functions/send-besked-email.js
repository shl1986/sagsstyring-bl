  ...
  const html = `
    <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto">
      ...
      <div style="border:1px solid #e5e7eb;border-top:none;padding:20px;border-radius:0 0 6px 6px">
        ...
        <a href="${APP_URL}?sag=${sag.ordrenummer}" style="background:#B81C2B;color:#fff;padding:10px 20px;border-radius:4px;text-decoration:none;font-size:14px;font-weight:600">Åbn sag #${sag.ordrenummer}</a>
